...
public class OperationManager {
	...
	/**
	 * This method is responsible for getting the next transaction from
	 * memory and calling the appropriate method to execute the
	 * transaction.
	 ...
	 * is called by doTransaction when the transaction code is 01. It proceeds
     * to call the newUser() method in Accounts. If any errors are reported it
     * logs them to xstream.log and outputs the error to terminal.
	 * @param name a String that represents the name of User
	 * @param type a String that represents the type of User. Acceptable
	 * values are AA, BS, SS, BB
	 ...
	 * @return 0 on success, 1 on failure.
	 */
	public int doBuy(String event, String seller, int numTickets, double price) {
	 ...
	 * terminal.
	 * @param event a string that represents the name of an Event.
	 * @param seller a string that represents the name of the User selling the
	 * tickets.
	 * @param numTickets an integer that represents the number of tickets.
	 * @param price a double that represents the price of a Ticket.
	 * @return 0 on success, 1 on failure.
	 */
	public int doSell(String event, String seller, int numTickets, double price) {
	 ...
	 * @param amount a double that represents the amount of credit to be
	 * refunded.
	 * @return 0 on success, 1 on failure.
	 */
	public int doRefund(String buyer, String seller, double amount) {
	 ...
	 * @return 0 on success, 1 on failure.
	 */
	public int doAddCredit(String name, double amount) {
